...
warnIfPublicAssetMissing('/apple-touch-icon.png', 'apple touch icon')
warnIfPublicAssetMissing('/site.webmanifest', 'web manifest')
const defaultOgImage = resolveOgImage('/kiano-graph.png')
