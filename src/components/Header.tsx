...
function ThemeToggle() {
  ...
  return (
    ...
    >
      <SunIcon className="h-6 w-6 fill-zinc-100 stroke-zinc-500 transition group-hover:fill-zinc-200 group-hover:stroke-zinc-700 dark:hidden [@media(prefers-color-scheme:dark)]:fill-secondary/15 [@media(prefers-color-scheme:dark)]:stroke-secondary [@media(prefers-color-scheme:dark)]:group-hover:fill-secondary/15 [@media(prefers-color-scheme:dark)]:group-hover:stroke-secondary" />
      <MoonIcon className="hidden h-6 w-6 fill-zinc-700 stroke-zinc-500 transition not-[@media_(prefers-color-scheme:dark)]:fill-secondary/10 not-[@media_(prefers-color-scheme:dark)]:stroke-secondary dark:block [@media(prefers-color-scheme:dark)]:group-hover:stroke-zinc-400" />
    </button>
  )
}
